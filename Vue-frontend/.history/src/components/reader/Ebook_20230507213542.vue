...
const setTheme = (index) => {
  console.log(themeList[index].name)
  defaultSetting.theme = index
...
<template>
  <div>
    ...
    <TitleBar :ifTitleAndMenuShow="ifTitleAndMenuShow"></TitleBar>
      ...
      <MenuBar :ifTitleAndMenuShow="ifTitleAndMenuShow" ref="menubar" @setFontSize="setFontSize" @setTheme="setTheme" :themeList="themeList"></MenuBar>
    </div>
  </div>
</template>
