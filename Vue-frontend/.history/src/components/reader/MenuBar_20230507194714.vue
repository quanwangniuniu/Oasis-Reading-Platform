...
const menuStopPropagation = (event) =>{
    console.log('xxx')
}
...
<template>
    <div class="menu-bar">
        ...
        <Transition name="slide-up">
            <div class="setting-wrapper" v-show="isSettingShow" @click="menuStopPropagation" @click.stop>
                <div class="setting-font-size">
                    <n-slider v-model:value="value" :marks="marks" step="mark" class="slider" />
                </div>
            </div>
        </Transition>
