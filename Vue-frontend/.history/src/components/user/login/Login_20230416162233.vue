...
import { PersonOutline, LockClosedOutline,PhonePortraitOutline,DeviceMobileMessage } from '@vicons/ionicons5'
...
<template>
  <div class="login-card">
    <div class="login-container">
      ...
      <n-input placeholder="用户名" class="input">
        <template #prefix>
      ...
      <n-input placeholder="确认密码" class="input">
        <template #prefix>
          <n-icon :component="LockClosedOutline" color="black"/>
        </template>
      </n-input>
      ...
      <n-input placeholder="验证码" class="input">
        <template #prefix>
          <n-icon :component="DeviceMobileMessage" color="black"/>
        </template>
