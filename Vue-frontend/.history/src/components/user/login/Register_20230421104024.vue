    ...
    <div class="login-container">
      ...
      <n-form :model="registerForm" :rules="rules">
        <n-form-item path="username" label="用户名">
          <n-input placeholder="请输入用户名" class="input" v-model:value="registerForm.username">
            <template #prefix>
        ...
        <n-form-item path="password" label="密码">
          <n-input placeholder="请输入密码" type="password" class="input" v-model:value="registerForm.password">
            <template #prefix>
        ...
        <n-form-item path="password" label="确认密码">
          <n-input placeholder="请再次输入密码" type="password" class="input" v-model:value="checkPassword">
            <template #prefix>
              <n-icon :component="LockClosedOutline" color="black" />
            </template>
          </n-input>          
        ...
        <n-form-item path="phone" label="手机号">
          <n-input placeholder="请输入手机号" class="input" v-model:value="registerForm.phone">
            <template #prefix>
