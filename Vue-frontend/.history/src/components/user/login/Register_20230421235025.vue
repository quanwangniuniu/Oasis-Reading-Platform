...
import {  validatePassword, validatePhone, validateUsername, validateCode} from '../../../util/validate'
...
let register = () => {
  api_addUser(registerForm.value).then((res) => {
    ...
    if (res.data.code === 200) {
      // api_login(registerForm.value.phone, registerForm.value.password).then(res => {
      //   if (res.data.code == 0) {
...
<template>
  <div class="login-card">
    <div class="login-container">
      ...
      <button class="commit-register-btn" @click="RegisterButtonClick()">注册</button>
    </div>
