...
import { api_getBooks, api_getBooksByPage } from '../../axios/api'
...
<template>
  <div>
    ...
    <div class="container">
      <ul v-infinite-scroll="load" class="infinite-list container" style="overflow: auto">
        <BookCard v-for="book in books" :key="book.id" class="card infinite-list-item" :book-info="book"></BookCard>
      </ul>
