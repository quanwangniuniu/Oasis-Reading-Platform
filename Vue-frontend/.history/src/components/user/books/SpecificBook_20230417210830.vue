  ...
  <div>
    ...
    <div class="container">
      ...
      <div class="write-comments">
        <n-button secondary strong :render-icon="renderIcon1" class="operation-btn"  color="#ff69b4">
          想读
        </n-button>

        <n-button secondary strong :render-icon="renderIcon2" class="operation-btn"  color="#ff69b4">
          添加到收藏夹
        </n-button>

        <n-button secondary strong :render-icon="renderIcon3" class="operation-btn"  color="#ff69b4">
          写短评
        </n-button>
