...
<template>
  ...
  <n-modal v-model:show="showModal_rate" class="custom-card" preset="card" title="写短评" style="width: 600px"
    :bordered="false">
    <div class="rate-card">
      <div>点击星星评分</div>
      <n-rate allow-half :value="rateObj.rate"/>
    </div>
    <n-input type="textarea" maxlength="250" placeholder="说说你读过之后的感受吧" v-model:value="rateObj.comment" resize="none" :autosize="{
      minRows: 3,
      maxRows: 5
    }" show-count />
  </n-modal>
