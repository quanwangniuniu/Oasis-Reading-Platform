...
<template>
  <div>
    ...
    <div class="container">
      ...
      <div class="operation">
        ...
        <n-button secondary strong :render-icon="renderIcon3" class="operation-btn"  color="rgb(2, 108, 2)" @click="showModal_rate=true">
          写短评
        </n-button>
  ...
  <div>写点评论吧</div>
  <n-input type="textarea" maxlength="250" placeholder="说说你读过之后的感受吧" resize="none" show-count />
  </n-modal>
</template>
