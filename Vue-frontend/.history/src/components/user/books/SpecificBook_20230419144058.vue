...
import { api_addFavourite } from '../../axios/api_favourite'
...
const addFavourite = () => {
  favouriteObj.value.type = 1
  api_addFavourite.then(res=>{
  ...
  <div>
    ...
    <div class="container">
      ...
      <div class="operation">
        ...
        <n-button secondary strong :render-icon="renderIcon2" class="operation-btn" color="rgb(2, 108, 2)" v-if="!operationState.isFavourited" @click="addFavourite">
          添加到收藏夹
        </n-button>
