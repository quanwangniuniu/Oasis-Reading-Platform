...
const showModal_read = ref(false)
// 书籍评分对象
const rateObj = ref({
  book_id: id,
  rate: null,
...
<template>
      ...
      <div class="book-info">
        ...
        <div class="info-and-rate">
          <div class="rate-container">
            ...
            <div class="book-star"><n-rate allow-half readonly :value="Number(book.rate) / 2" /></div>
          </div>
  ...
  <!-- <n-modal v-model:show="showModal_read" >
    <n-card style="width: 1200px; height: 800px;" :title=book.title :bordered="false" size="huge" role="dialog" aria-modal="true">
      xxx
    </n-card>
  </n-modal> -->

  <n-modal
    v-model:show="showModal_read"
    preset="card"
    style="width: 1200px; height: 800px;"
  >
  <n-card  :title=book.title :bordered="false" size="huge" role="dialog" aria-modal="true">
      xxx
    </n-card>
  </n-modal>
</template>
