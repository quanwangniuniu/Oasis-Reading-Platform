...
import { TimeOutline, BookmarksOutline, CheckmarkSharp } from '@vicons/ionicons5'
...
<template>
  ...
  <n-modal v-model:show="showModal_rate" class="rate-card" preset="card" title="写短评" style="width: 600px"
    :bordered="false">
    <div>点击星星评分</div>
    <div><n-rate allow-half :value="rateObj.rate" :on-update:value="changeRate()"/></div>
    <div>
    ...
    <div>
      <n-button strong secondary type="primary" class="commit-rate-btn">
        提交
      </n-button>
    </div>
  </n-modal>
