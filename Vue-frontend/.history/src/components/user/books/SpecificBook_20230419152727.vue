  ...
  <div>
    ...
    <div class="container">
      ...
      <div class="book-info">
        ...
        <div class="info-and-rate">
          <div class="rate-container">
            ...
            <div class="book-star"><n-rate readonly :default-value="Number(book.rate_avg) / 2" /></div>
          </div>
      ...
      <div class="operation">
        ...
        <n-button secondary strong :render-icon="renderIcon1" class="operation-btn" color="rgb(207, 64, 64)" v-if="operationState.isWanted">
          取消想读
        </n-button>
        ...
        <n-button  secondary strong :render-icon="renderIcon2" class="operation-btn" color="rgb(207, 64, 64)" v-if="operationState.isFavourited">
          取消收藏
        </n-button>

        <n-button secondary strong :render-icon="renderIcon3" class="operation-btn" color="rgb(2, 108, 2)" v-if="!operationState.isCommented"
          @click="showModal_rate = true">
          写短评
        </n-button>

        <n-button secondary strong :render-icon="renderIcon1" class="operation-btn" color="rgb(207, 64, 64)" v-if="operationState.isCommented">
          删除短评
        </n-button>
