  ...
  <div>
    ...
    <div class="container">
      ...
      <div class="write-comments">
        <n-button secondary strong :render-icon="renderIcon1">
          想读
        </n-button>

        <n-button secondary strong :render-icon="renderIcon2">
          添加到收藏夹
        </n-button>

        <n-button secondary strong :render-icon="renderIcon3">
          写短评
        </n-button>
