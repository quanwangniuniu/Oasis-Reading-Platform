...
const deleteComment = () => {
  api_deleteCommentById(id).then(res => {
    console.log(res)
    operationState.value.isCommented = false
  })
}
  ...
  <div>
    ...
    <div class="container">
      ...
      <div class="operation">
        ...
        <n-button secondary strong :render-icon="renderIcon1" class="operation-btn" color="rgb(207, 64, 64)" v-if="operationState.isCommented" @click="deleteComment">
          删除短评
        </n-button>
