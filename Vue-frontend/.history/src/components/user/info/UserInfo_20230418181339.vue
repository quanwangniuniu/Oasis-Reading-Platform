...
import { MaleFemaleOutline } from '@vicons/ionicons5'
const userInfo = ref({})
      ...
      <div class="left-container">
        ...
        <div class="user-info">
          ...
          <div class="info-list">
            ...
            <div>
              <n-icon size="18" :component="MaleFemaleOutline"/>&nbsp;生日: &nbsp; {{ userInfo.birthday}}
            </div>
            <div>
              <n-icon size="18" :component="MaleFemaleOutline"/>&nbsp;手机号: &nbsp; {{ userInfo.phone == null ? '未绑定' : userInfo.phone}}
            </div>
            <div>
              <n-icon size="18" :component="MaleFemaleOutline"/>&nbsp;邮箱: &nbsp; {{ userInfo.email == null ? '未绑定' : userInfo.email}}
            </div>
          </div>
        </div>
      </div>
