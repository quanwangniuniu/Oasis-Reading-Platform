        ...
        <n-popover trigger="hover" :show-arrow="false">
            <template #trigger>
                <div>
                    ...
                    <el-upload class="upload-container" action="http://127.0.0.1:5000/uploadCover" :show-file-list="false"
                    ...
                    <!-- <n-upload action="http://127.0.0.1:5000/upload/avatar" preset="card" :headers="{
                        'Authorization': `Bearer ${token}`
                    }" @finish="handleFinish" class="upload-container">
                        <div class="dragger-container">
                            <img :src=userInfo.avatar alt="" class="edit-avatar">
