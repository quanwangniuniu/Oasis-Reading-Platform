    ...
    <div class="container">
      ...
      <div class="comment-container">
        <div class="comment-info">
          <div class="title">
            <router-link v-if="userType == 2" :to="'/admin/books/' + props.bookInfo.id" class="name">{{ commentObj.title }}</router-link>
                <router-link v-if="userType != 2" :to="'/books/' + props.bookInfo.id" class="name">{{ commentObj.title }}</router-link>
          </div>
          <div class="rating">
