        ...
        <div>
            <div class="container">
                <div class="left">
                    ...
                    <div class="nav"><router-link to="/admin/managebooks/add">话题管理</router-link></div>                    
                </div>
                ...
                <div class="right">
                    ...
                    <div class="nav"><router-link to="/admin/explore">发现</router-link></div>
                    <div class="nav"><router-link to="/admin/books">图书</router-link></div>
                    <div class="nav"><router-link to="/admin/movies">影视</router-link></div>
                    <div class="login"><router-link to="/admin/transit" @click="logout()">登出</router-link></div>                    
                </div>
