        ...
        <div class="book-form">
          ...
          >
            <el-form-item label="书名" style="width:420px">
              <el-input v-bind="bookItem.title" />
            </el-form-item>
            <el-form-item label="作者">
              <el-input v-bind="bookItem.author" />
            </el-form-item>
            <el-form-item label="出版社">
              <el-input v-bind="bookItem.publisher" />
            </el-form-item>
            <el-form-item label="简介" style="width:420px">
                <el-input v-bind="bookItem.description" type="textarea"/>
            </el-form-item> 
            <el-form-item label="ISBN">
              <el-input v-bind="bookItem.isbn" />
            </el-form-item>
            <el-form-item label="装帧">
              <el-input v-bind="bookItem.binding" />
            </el-form-item>
            <el-form-item label="页数">
              <el-input v-bind="bookItem.page" />
            </el-form-item>
            <el-form-item label="价格">
              <el-input v-bind="bookItem.price" />
            </el-form-item>
            <el-form-item label="系列名">
              <el-input v-bind="bookItem.seriers" />
            </el-form-item>
            <el-form-item label="出版日期">
              <el-input v-bind="bookItem.publish_year" />
            </el-form-item>
          </el-form>
        </div>
