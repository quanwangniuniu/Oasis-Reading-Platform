...
import { api_getBooks, api_deleteBookById } from '../../axios/api'
  ...
  <div class="list-container">
    ...
    <div class="pagination">
      <div class="example-pagination-block">
        <el-pagination layout="prev, pager, next" :total="1000" :current-page="current_page" @current-change="changePage"/>
        <el-pagination small layout="prev, pager, next" :total="50" :current-page="current_page" @current-change="changePage"/>
      </div>
    </div>
  </div>
</template>
