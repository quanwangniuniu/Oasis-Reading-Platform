        ...
        <div class="book-form">
          <n-form ref="formRef" :model="bookItem" >
            <n-grid :cols="24" :x-gap="24">
              ...
              <n-form-item-gi path="binding" label="价格" :span="12">
                <n-input 
                  placeholder="请输入价格" 
                  class="input" 
              ...
              <n-form-item-gi path="seriers" label="系列名" :span="12">
                <n-input 
                  placeholder="请输入系列名" 
                  class="input" 
                  v-model:value="bookItem.seriers"
                >
                </n-input>  
              </n-form-item-gi>

              <n-form-item-gi path="publish_year" label="装帧" :span="12">
                <n-input 
                  placeholder="请输入出版日期" 
                  class="input" 
